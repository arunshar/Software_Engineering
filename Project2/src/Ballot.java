...
public class Ballot {
  ...
  public int increment_rank() {
   ...
   /**
   * Returns the number of ranked candidates for the ballot
   * @return the number of ranked candidates for the ballot
   */
  public int ranking_count() { return rankings.length; }
