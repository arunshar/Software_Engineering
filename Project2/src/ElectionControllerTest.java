...
public class ElectionControllerTest extends SVS {
    /**
     ...
     * @throws IOException if there is a failure when trying to write to the audit
     *         file.
     */
    @Test
    public void distributeBallot() throws IOException {
     ...
     */         
    @Test
    public void redistributeBallot() throws IOException {
        boolean shuffle = false;
        File test_file = new File("testing/test.csv");
        ArrayList<File> file_list = new ArrayList<>();
        file_list.add(test_file);
     ...
     */         
    @Test
    public void customAuditFileMsg() throws IOException {
        boolean shuffle = false;
        File test_file = new File("testing/test.csv");
        ArrayList<File> file_list = new ArrayList<>();
        file_list.add(test_file);
